...
class UserPreferences(context: Context) {
    ...
    fun getModelPath(): String = prefs.getString(KEY_MODEL_PATH, "/data/local/tmp/gemma-3-2b-it-cpu-int4.litertlm") ?: "/data/local/tmp/gemma-3-2b-it-cpu-int4.litertlm"
    ...
    fun getMaxTokens(): Int = prefs.getInt(KEY_MAX_TOKENS, 4096)
    ...
    fun setImportedModels(models: List<com.telo.tinyzora.core.inference.ImportedModel>) {
        val jsonStr = json.encodeToString(kotlinx.serialization.builtins.ListSerializer(com.telo.tinyzora.core.inference.ImportedModel.serializer()), models)
